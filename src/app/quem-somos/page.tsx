          ...
          <div className="grid lg:grid-cols-5 gap-12 lg:gap-16">
            ...
            >
              ...
              <div className="relative mb-8">
                <div className="aspect-[3/4] rounded-2xl bg-gradient-to-br from-gold-100 to-gold-200 overflow-hidden">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                      <div className="w-32 h-32 mx-auto mb-4 rounded-full bg-gold-300/50 flex items-center justify-center">
                        <span className="text-4xl font-bold text-gold-700">FA</span>
                      </div>
                      <p className="text-sm text-gold-600">Foto da Dra. Flávia</p>
                    </div>
                  </div>
                </div>
                {/* Decorative Badge */}
